...
# Loading the data
data <- read.csv("~/Escritorio/Data Science/Master's Project/readmissions160315.csv", header = TRUE)

# Changing possible blanks for NA
data <- read.csv("~/Escritorio/Data Science/Master's Project/readmissions160315.csv", header=T, na.strings=c(""," ","NA"))
